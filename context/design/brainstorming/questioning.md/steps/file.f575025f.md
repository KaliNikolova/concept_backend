---
timestamp: 'Fri Nov 07 2025 10:35:31 GMT-0500 (Eastern Standard Time)'
parent: '[[..\20251107_103531.2e4fdc85.md]]'
content_id: f575025f62cd630afca42b950aca97b800ecc27a683da2925da65c8381b52714
---
...
export const GetUserProfileRequest: Sync = ({ request, session, user, profile }) => ({
  ...
  where: async (frames) => {
    ...
    // If this query fails, `frames` becomes empty and the `then` clause doesn't fire.
