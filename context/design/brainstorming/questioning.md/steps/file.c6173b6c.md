...
content_id: c6173b6cd081900b1c4b270a1aff642089f8af1c57cedb48674d70614ae63b12
---
...
export default class UserAccountConcept {
   ...
   * @returns {Promise<{ user: User }[]>} The user ID in an array, or an empty array if not found.
   */
